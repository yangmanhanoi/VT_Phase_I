...
import com.namduong.viettel.services.BaseRedisService;
...
public class BaseRedisServiceImpl implements BaseRedisService {
    ...
    @Override
    public void setTimeToLiveInMinutes(String key, Long timestamp) {
        redisTemplate.expire(key, timestamp, TimeUnit.MINUTES);
    }
